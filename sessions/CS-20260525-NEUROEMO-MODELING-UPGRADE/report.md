...
**Session ID:** `CS-20260525-NEUROEMO-MODELING-UPGRADE`  
**Agent signature:** `Historical Cursor coding agent`  
**Context contract:** Future agents may cite this session ID when asking about NeuroEmo modeling experiments, richer ROI summaries, temporal windows, MLPs, label merges, and specialist classifiers.  
