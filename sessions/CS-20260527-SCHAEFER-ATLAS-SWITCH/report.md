...
**Session ID:** `CS-20260527-SCHAEFER-ATLAS-SWITCH`  
**Agent signature:** `Historical Cursor coding agent`  
**Context contract:** Future agents may cite this session ID when asking about switching NeuroEmo ROI training from volumetric projection to CBIG FreeSurfer surface `.annot` labels.  
