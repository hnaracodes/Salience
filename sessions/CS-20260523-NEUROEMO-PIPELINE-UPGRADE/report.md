...
**Session ID:** `CS-20260523-NEUROEMO-PIPELINE-UPGRADE`  
**Agent signature:** `Historical Cursor coding agent`  
**Context contract:** Future agents may cite this session ID when asking about the NeuroEmo supervised training pipeline, Schaefer ROI extraction, temporal windows, neutral handling, and preprocessing handoff.  
