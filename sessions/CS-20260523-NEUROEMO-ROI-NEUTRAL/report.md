...
**Session ID:** `CS-20260523-NEUROEMO-ROI-NEUTRAL`  
**Agent signature:** `Historical Cursor coding agent`  
**Context contract:** Future agents may cite this session ID when asking about NeuroEmo ROI feature training, dataset repair, and balanced neutral-class setup.  
